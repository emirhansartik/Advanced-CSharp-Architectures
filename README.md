...
* **Mimari:** DTO (Data Transfer Object) ve Repository Pattern
...
| :--- | :--- | :--- | :--- |
| **1** | **Project1_DapperNorthwind** | Dapper Micro-ORM ile CRUD operasyonları ve saf SQL kullanımı. | 🟢 Aktif |
| **2** | **Web API Hava Durumu** | .NET Web API altyapısının kurulması ve endpoint tasarımı. | ⏳ Beklemede |
